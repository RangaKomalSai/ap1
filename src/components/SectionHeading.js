...
function SectionHeading({ back_heading, main_heading, light }) {
  return (
    <div className="flex flex-col justify-center items-center w-full" >
      <div className="relative w-full h-32 flex items-end justify-center overflow-hidden" data-aos="zoom-in">
      ...
      <div className="h-2 w-20 flex space-x-2 my-6" >
        ...
        <div className="h-full w-[80%] bg-gradient-to-r from-[#B2EBF2] via-[#D1C4E9] to-[#F8BBD0] rounded opacity-60" data-aos="fade-left"></div>
      </div>
    </div>
  );
}
