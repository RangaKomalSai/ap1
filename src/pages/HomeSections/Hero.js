      ...
      <div className="absolute inset-0 z-0 md:hidden opacity-80">
        ...
        >
          <img
            src={ap}
            alt="Logo"
            className="md:h-96 md:w-auto w-[90%] h-auto"
            draggable="false"
            data-aos="fade-right"
          />
          <div className="flex justify-center md:justify-end items-center w-full my-4 md:mr-32">
            <Link to="/register">
              <button
                className="bg-[#41BDEE] hover:bg-blue-600 text-[20px] md:text-[25px] text-white font-extrabold py-2 px-4 mt-10 md:mt-0 rounded-full text-lg"
                data-aos="zoom-in-up"
              >
                REGISTER NOW
              </button>
